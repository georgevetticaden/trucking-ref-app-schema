...
public class TruckGeoEventEnriched extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<TruckGeoEventEnriched> ENCODER =
      new BinaryMessageEncoder<TruckGeoEventEnriched>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<TruckGeoEventEnriched> DECODER =
      new BinaryMessageDecoder<TruckGeoEventEnriched>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<TruckGeoEventEnriched> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<TruckGeoEventEnriched> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TruckGeoEventEnriched>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this TruckGeoEventEnriched to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a TruckGeoEventEnriched from a ByteBuffer. */
  public static TruckGeoEventEnriched fromByteBuffer(
  ...
  @Deprecated public java.lang.CharSequence geoAddress;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 12: geoAddress = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'geoAddress' field.
   * @return The value of the 'geoAddress' field.
   */
  public java.lang.CharSequence getGeoAddress() {
    return geoAddress;
  }

  /**
   * Sets the value of the 'geoAddress' field.
   * @param value the value to set.
   */
  public void setGeoAddress(java.lang.CharSequence value) {
  ...
  /**
   * Creates a new TruckGeoEventEnriched RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new TruckGeoEventEnriched RecordBuilder by copying an existing TruckGeoEventEnriched instance.
  ...
  /**
   * RecordBuilder for TruckGeoEventEnriched instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TruckGeoEventEnriched>
    implements org.apache.avro.data.RecordBuilder<TruckGeoEventEnriched> {
    ...
    private java.lang.CharSequence geoAddress;
    ...
    private Builder(hortonworks.hdf.schema.refapp.TruckGeoEventEnriched.Builder other) {
      ...
      if (isValidValue(fields()[12], other.geoAddress)) {
        this.geoAddress = data().deepCopy(fields()[12].schema(), other.geoAddress);
    ...
    /**
      * Checks whether the 'geoAddress' field has been set.
      * @return True if the 'geoAddress' field has been set, false otherwise.
      */
    public boolean hasGeoAddress() {
    ...
    public TruckGeoEventEnriched build() {
      try {
        TruckGeoEventEnriched record = new TruckGeoEventEnriched();
        ...
        record.geoAddress = fieldSetFlags()[12] ? this.geoAddress : (java.lang.CharSequence) defaultValue(fields()[12]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<TruckGeoEventEnriched>
    WRITER$ = (org.apache.avro.io.DatumWriter<TruckGeoEventEnriched>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<TruckGeoEventEnriched>
    READER$ = (org.apache.avro.io.DatumReader<TruckGeoEventEnriched>)MODEL$.createDatumReader(SCHEMA$);
